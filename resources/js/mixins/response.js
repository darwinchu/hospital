...
export default {
    ...
    methods: {
        ...
        runAlert(message, title, type, options, hasMultiError) {
            return new Promise((resolve, reject) => {

                /* Display notifications */
                switch(type) {
                    case 'error': Swal.fire(title ? title : 'Error', message, 'error'); break;
                    case 'warning': Swal.fire(title ? title : 'Warning', message, 'warning'); break;
                    case 'success': Swal.fire(title ? title : 'Success', message, 'success'); break;
                    case 'info': Swal.fire(title ? title : 'Info', message, 'info'); break;
                }
            });
        },
